...
(async () => {
    ...
    await page.goto('https://launches.hanon-shop.com/collections/launch/products/nike-air-jordan-1-retro-high-og-black-gym-red-satin-555088060');
    // document.getElementsByName("profile[usSize]")[0].value = profile.usSize;
    //     $('div.icheckbox_minimal').iCheck('check');
        
        await page.click('#nike-air-jordan-1-retro-high-og-quot-black-gym-red-satin-quot');
